...
const pizzaMenu: Product[] = [
  {
    id: 'margherita',
    title: 'Маргарита',
    price: 450, // базовая цена за 25 см
    img: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400&h=300&fit=crop&crop=center',
    description: 'Томатный соус, моцарелла, базилик',
    discount: 15,
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 10 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 8 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 5 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
      { id: 'spicySauce', value: 'Острый соус', priceModifier: 50, isEnable: true }
    ],
    tags: {
      name: 'Состав',
  ...
  },
  {
    ...
    discount: 10,
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 12 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 9 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 6 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
      { id: 'extraPepperoni', value: 'Доп. пепперони', priceModifier: 200, isEnable: true }
    ],
    tags: {
      name: 'Состав',
  ...
  },
  {
    ...
    discount: 20,
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 7 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 6 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 4 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
  ...
  },
  {
    ...
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 10 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 7 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 5 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
      { id: 'extraPineapple', value: 'Доп. ананас', priceModifier: 100, isEnable: true }
    ],
    tags: {
      name: 'Состав',
  ...
  },
  {
    ...
    description: 'Томатный соус, моцарелла, перец, грибы, лук',
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 15 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 10 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 6 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
      { id: 'extraMushrooms', value: 'Доп. грибы', priceModifier: 120, isEnable: true }
    ],
    tags: {
      name: 'Состав',
  ...
  },
  {
    ...
    description: 'Барбекю соус, моцарелла, курица, лук, кинза',
    variants: [
      { id: '25cm', value: '25 см', priceModifier: 0, stock: 8 },
      { id: '30cm', value: '30 см', priceModifier: 200, stock: 6 },
      { id: '35cm', value: '35 см', priceModifier: 400, stock: 4 }
    ],
    options: [
      { id: 'cheeseCrust', value: 'Сырный бортик', priceModifier: 150, isEnable: true },
      { id: 'extraChicken', value: 'Доп. курица', priceModifier: 180, isEnable: true }
    ],
    tags: {
      name: 'Состав',
